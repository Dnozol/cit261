...
import Comment from './comment_module.js';
const myComment = new Comment(document.querySelector('#hikes'), 'hike');
...
const hikeList = [
  ...
  export default class Hikes {
    constructor(elementId) {
      ...
      this.comments = new this.comments('hikes', 'comments');
    }
  ...
  function renderOneHikeFull(hike) {
    ...
    item.innerHTML = ` 
          ...
          <textarea id='${hike.name}' placeholder='Add comment'></textarea>
        
          <button id="addButton" data-hike='${hike.name}'>click</button>
      `;
    return item;
  }